...
export async function POST(req: Request) {
  ...
  await sql`INSERT INTO pieces
    (id,ed,name_en,name_ar,price,currency,coll_key,fabric,sil,colour,occ,mat_en,mat_ar,silf_en,silf_ar,pal_en,pal_ar,availability,desc_en,desc_ar,story_en,story_ar,image,images,pants_image,pants_price)
    VALUES (${b.id}, ${str(b.ed, 40)}, ${str(b.n, 200)}, ${str(b.ar, 200)}, ${nonNegativeInt(b.price)}, ${b.currency || 'SAR'}, ${b.coll || null},
